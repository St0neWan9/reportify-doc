...
|   category       | str   | 文档类别（`fillings`, `transcripts`, `reports`, `news`, `webpage`）。 |
|   type           | str   | 报告类型及类别（如 `filling`, `transcript`, `news` 等）。                |
...
**cURL**
```bash
curl -X GET https://api.reportify.cc/v1/contents/1046895208953942016 \
...
url = "https://api.reportify.cc/v1/contents/1046895208953942016"
headers = {
